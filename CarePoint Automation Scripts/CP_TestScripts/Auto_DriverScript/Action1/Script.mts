'+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
								'Carepoint Auto-LOB (Automobile) DriverScript
...
Environment.Value("ExecutionResultsPath") = gstrRelativePath & "\CP_Results\Auto"
...
'			SystemUtil.CloseProcessByName "iexplore.exe"
			DataTable.GetSheet("Common Data").SetCurrentRow(counter)
			DataTable.GetSheet("Claimant Info").SetCurrentRow(counter)
			DataTable.GetSheet("First Party Vehicle").SetCurrentRow(counter)
			DataTable.GetSheet("Third Party Vehicle").SetCurrentRow(counter)
			DataTable.GetSheet("Pedestrian").SetCurrentRow(counter)
			DataTable.GetSheet("Third Party Property").SetCurrentRow(counter)
'			DataTable.GetSheet("WC").SetCurrentRow(counter)
			...
			Call Auto_ExcelReport_Generation()
			Call Auto_Update_Regression_Tracker()
			Call Clear_Cookies()
		End If
	Next
